...
$(function () {
  ...
  function changeImg2() {
    $(".section2 h2 img").attr(
      "src",
      "http://m.dunkindonuts.co.kr/assets/images/main/tit_new_event.png"
    );
    $(".section4 h2 img").attr(
      "src",
      "http://m.dunkindonuts.co.kr/assets/images/main/tit_menu.png"
    );
    $(".section6 h2 img").attr(
      "src",
      "http://m.dunkindonuts.co.kr/assets/images/main/tit_sns.png"
    );
  }
});
//제이쿼리 끝
